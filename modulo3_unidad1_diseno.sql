...
CREATE TABLE inventario(
  id_producto INT PRIMARY KEY, -- INT: identificador numérico único, no requiere decimales
  nombre_producto VARCHAR(100), -- VARCHAR(100): texto de longitud variable, suficiente para el nombre de un producto
  categoria VARCHAR(50),
  precio_unitario DECIMAL (10,2),
  stock_actual INT,
  stock_minimo INT,
  fecha_ingreso DATE,  -- DATE: almacena solo la fecha, sin hora, suficiente para registrar el ingreso al inventario
  activo TINYINT(1) -- TINYINT(1): valor numérico pequeño, 1 = disponible, 0 = descontinuado
);
